...
:: ============================================================================
:: Windows 10 Tiny Builder - Clean Version (FIXED)
:: ============================================================================
set "SCRIPT_DIR=%~dp0..\"
...
set "AppXInject=%~dp0..\..\App_LTSC\LTSC_W10"

echo ============================================================================
echo      Windows 10 Tiny Builder - Clean Version (FIXED)
echo ============================================================================
echo.
...
call "%SCRIPT_DIR%ScriptModules\Features_Debloater_W10.cmd" "%MOUNT_DIR%"
if !errorlevel! neq 0 (
...
call "%SCRIPT_DIR%ScriptModules\Registry_Tweaks_W10.cmd" "%MOUNT_DIR%"
if !errorlevel! neq 0 (
